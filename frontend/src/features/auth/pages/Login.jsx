...
import useDarkMode from "../../../app/hooks/UseDarkMode"; // Importo el hook para el modo oscuro
import { AuthContext } from "../../../app/context/AuthContext"; //importarmos el contexto
...
export default function Login() {
  ...
  if (isLoading) {
    return <div className="text-center mt-4">Cargando...</div>; // Mensaje de carga mientras esperamos la autenticación
  }
