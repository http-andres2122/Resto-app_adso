...
import usuarioController from "../../controllers/users/usuarioController.js";
...
router.put("/:id/password", usuarioController.updatePassword); // Actualizar la contraseña de un usuario
